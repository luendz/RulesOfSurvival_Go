...
namespace ROS.Game.Weapons
{
        ...
        MonoBehaviour
    {
            ...
            )
        {
            ...
            {
                Debug.LogError(
                    $"{weapon.name} no tiene WeaponMount configurado en su prefab.",
                    weapon
                );
            }
            ...
            )
        {
            ...
            {
                Debug.LogError(
                    $"{weapon.name} no tiene WeaponEffects configurado en su prefab.",
                    weapon
                );
            }
            ...
            {
                Debug.LogError(
                    $"{weapon.name} no tiene WeaponRecoil configurado en su prefab.",
                    weapon
                );
            }
        }
