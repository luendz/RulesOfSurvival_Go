...
namespace ROS.Game.Loot
{
        ...
        IPrioritizedInteractable
    {
        ...
        public static DeathLootContainer Create(
            ...
            DeathLootVisualDefinition visualDefinition = null
        )
        {
            ...
            container.CreateVisual(visualDefinition);
        ...
        public void Interact(GameObject interactor)
        {
            ...
            RulesOfSurvivalHUDNearbyLootPresenter.OpenConfigured(
                this,
                interactor
            );
        }
        ...
        private void CreateVisual(DeathLootVisualDefinition definition)
        {
            if (
                definition == null ||
