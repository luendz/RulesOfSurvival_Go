...
namespace ROS.Game.CameraSystem
{
    public sealed class ThirdPersonCamera : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_camera == null || target == null || input == null ||
                equipment == null || leanController == null || _parachute == null)
            {
                Debug.LogError($"[{nameof(ThirdPersonCamera)}] Referencias incompletas en '{name}'.", this);
                enabled = false;
                return;
            }
