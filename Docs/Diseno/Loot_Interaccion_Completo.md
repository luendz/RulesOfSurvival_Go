...
- La caja de un jugador eliminado usa un modelo propio al 50% del tamaño inicial, flota ligeramente con un balanceo vertical corto y mantiene un halo azul sutil pegado al suelo.
